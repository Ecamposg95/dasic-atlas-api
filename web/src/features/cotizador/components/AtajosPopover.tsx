  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-20 right-4 z-30 h-10 w-10 rounded-full bg-slate-800 border border-slate-700 hover:border-accent-glow text-slate-300 hover:text-accent-glow shadow-lg flex items-center justify-center"
            ...
            <ul className="space-y-2">
              {atajos.map((a) => (
                <li key={a.combo} className="flex items-center justify-between text-sm">
                  ...
                  <kbd className="px-2 py-1 text-[10px] font-mono bg-slate-800 border border-slate-700 rounded text-slate-200">
                    {a.combo}
                  </kbd>
                </li>
              ))}

...
export function Modal({
  ...
  return (
    ...
    >
      <div className={cn('bg-white border border-slate-200 text-slate-900 rounded-xl shadow-2xl w-full p-5 dark:bg-slate-900 dark:border-slate-800 dark:text-slate-100', sizeCls)}>
